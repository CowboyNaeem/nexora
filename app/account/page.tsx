...
export default function AccountPage() {
   ...
   * LOADING
   *
   * Mobile and desktop have separate loading presentation.
   * No API or account logic is changed.
   * ============================================================
   */
  ...
  if (loading) {
    return (
      <>
        ...
        <div className="block min-h-screen bg-[#070709] px-5 py-6 text-white lg:hidden">
          <div className="mx-auto max-w-md animate-pulse">
            ...
            <div className="mt-6 h-36 rounded-[26px] bg-white/[0.035]" />

            <div className="mt-4 h-20 rounded-[22px] bg-white/[0.035]" />

            <div className="mt-7 grid grid-cols-2 gap-3">
              <div className="h-24 rounded-[20px] bg-white/[0.035]" />
              <div className="h-24 rounded-[20px] bg-white/[0.035]" />
              <div className="h-24 rounded-[20px] bg-white/[0.035]" />
              <div className="h-24 rounded-[20px] bg-white/[0.035]" />
            </div>

            <div className="mt-7 h-56 rounded-[22px] bg-white/[0.035]" />

          </div>
        </div>

        {/* DESKTOP LOADING — EXISTING STYLE */}

        <main className="hidden min-h-screen bg-[#070709] px-5 py-10 text-white sm:px-8 lg:block lg:px-12">
  ...
  if (error || !user) {
    return (
      <>
        ...
        <main className="block min-h-screen bg-[#070709] px-5 py-8 text-white lg:hidden">

          <div className="mx-auto max-w-md">

            <Link
              href="/"
              className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.025] text-white/60"
            >
              ←
            </Link>
            ...
            <div className="mt-10">
              ...
              <p className="text-[9px] font-semibold uppercase tracking-[0.22em] text-red-300">
                ACCOUNT UNAVAILABLE
              </p>
              ...
              <p className="mt-3 text-sm leading-6 text-white/35">
                Sign in to access your Nexora
                account, orders and saved
                products.
              </p>

              <Link
                href="/login"
                className="mt-7 inline-flex w-full items-center justify-center rounded-xl bg-white py-3.5 text-xs font-semibold text-black"
              >
                Sign in
              </Link>
...
/* ============================================================
   DESKTOP STAT CARD
   Existing desktop component preserved.
============================================================ */
