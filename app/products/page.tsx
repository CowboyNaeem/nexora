...
export default async function ProductsPage({
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#050507] pb-[84px] text-white lg:pb-0">
      <StoreHeader />
      ...
      <main>
        ...
        {/* =========================================================
            ...
            This is the recovered approved mobile design.
            Desktop is completely separate below.
        ========================================================= */}

        <section className="lg:hidden">

          <style>{`
            @keyframes nexoraMobileTitleReveal {
              0% {
                opacity: 0;
            ...
            @keyframes nexoraCategoryNameReveal {
              0% {
                opacity: 0;
            ...
            @keyframes nexoraCategoryChipEnter {
              0% {
                opacity: 0.55;
            ...
            .nexora-mobile-title-reveal {
              animation:
                nexoraMobileTitleReveal
                420ms
            ...
            .nexora-mobile-title-reveal-delay {
              animation-delay: 70ms;
            }

            .nexora-category-name-reveal {
              animation:
                nexoraCategoryNameReveal
                460ms
                cubic-bezier(0.22, 1, 0.36, 1)
                both;
            ...
            .nexora-category-chip-active {
              animation:
                nexoraCategoryChipEnter
                320ms
                cubic-bezier(0.22, 1, 0.36, 1)
                both;
          ...
          <div className="relative overflow-hidden border-b border-white/[0.06]">
            ...
            <div className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-violet-600/[0.10] blur-[90px]" />

            <div className="pointer-events-none absolute -left-24 top-32 h-56 w-56 rounded-full bg-indigo-600/[0.07] blur-[90px]" />

            <div className="relative px-5 pb-7 pt-5">

              {/* Breadcrumb */}

              <div className="mb-5 flex items-center gap-2 text-[9px] font-semibold uppercase tracking-[0.24em] text-white/25">
                ...
                {selectedCategory && (
                  <>
                    ...
                    <span className="truncate text-violet-300/75">
                      {selectedCategory.name}
                    </span>
                  </>
                )}
              ...
              <div className="max-w-[340px]">
                ...
                <p className="nexora-mobile-title-reveal text-[9px] font-bold uppercase tracking-[0.28em] text-violet-400">
                  {selectedCategory
                    ? "CATEGORY COLLECTION"
                    : searchQuery
                      ? "SEARCH RESULTS"
                ...
                <h1
                  key={`${selectedCategory?.slug ?? "all"}-${searchQuery || "browse"}`}
                  className="nexora-category-name-reveal mt-2 overflow-hidden text-[34px] font-semibold leading-[0.98] tracking-[-0.055em] text-white"
                >
                  {pageTitle}
                </h1>
                ...
                <p className="mt-3 text-[12px] leading-5 text-white/38">
                  {selectedCategory
                    ...
                    : searchQuery
                      ? `Products matching "${searchQuery}".`
                      : "Curated products worth discovering, selected for everyday life."}
                </p>
              ...
              <div className="mt-5 flex items-center gap-2">
                ...
                <span className="rounded-full border border-violet-400/15 bg-violet-500/[0.07] px-3 py-1.5 text-[10px] font-medium text-violet-200">
                  {products.length}{" "}
                  {products.length === 1
                    ? "product"
                    : "products"}
                ...
                {selectedCategory && (
                  <Link
                    href="/products"
                    className="rounded-full border border-white/[0.08] bg-white/[0.025] px-3 py-1.5 text-[10px] text-white/45"
                  >
                    View all
                  </Link>
                )}
          ...
          <div className="px-5 py-5">
            ...
            <div className="-mx-5 flex gap-2 overflow-x-auto px-5 pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              <Link
                href="/products"
                className={`inline-flex h-9 shrink-0 items-center gap-2 rounded-full border px-3 transition-all duration-300 ${
                  !selectedCategory
                    ? "nexora-category-chip-active border-violet-400/25 bg-violet-500/[0.10] text-white shadow-[0_0_24px_rgba(124,58,237,0.10)]"
              ...
              {categories.map((category) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="max-w-[105px] truncate text-[10px] font-semibold">
                      {category.name}
                    </span>
          ...
          <div className="border-t border-white/[0.05] px-5 pb-8 pt-6">
            ...
            {products.length === 0 ? (
              ...
              <div className="rounded-3xl border border-white/[0.07] bg-white/[0.018] px-5 py-12 text-center">

                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-violet-400/15 bg-violet-500/[0.06] text-violet-300">
                ...
                <Link
                  href="/products"
                  className="mt-5 inline-flex rounded-xl bg-white px-4 py-3 text-[11px] font-semibold text-black"
                >
                  Browse all products
                </Link>
                ...
                {products.map((product, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <article className="overflow-hidden rounded-[17px] border border-white/[0.07] bg-white/[0.018] transition-transform duration-300 active:scale-[0.985]">

                        {/* IMAGE */}

                        <div className="relative aspect-[0.94] overflow-hidden bg-[#0d0d11]">
                          ...
                          <div className="absolute left-2.5 top-2.5">
                            ...
                            <span className="rounded-full border border-white/10 bg-black/65 px-2 py-1 text-[7px] font-bold uppercase tracking-[0.10em] text-white/90 backdrop-blur-md">
                          ...
                          {hasDiscount &&
                            discountPercentage > 0 && (
                              ...
                              <span className="absolute right-2.5 top-2.5 rounded-full bg-violet-600 px-2 py-1 text-[7px] font-bold text-white">
                                -{discountPercentage}%
                              </span>
                          ...
                          <span className="absolute bottom-2.5 right-2.5 flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/75 text-base text-white backdrop-blur-md">
                            +
                          </span>
                        ...
                        <div className="p-3">
                          ...
                          <p className="truncate text-[8px] font-medium text-white/25">
                            {product.category.name}
                          </p>

                          <h3 className="mt-1 line-clamp-2 min-h-[30px] text-[11px] font-medium leading-[1.35] text-white/90">
                            {product.name}
                          </h3>
                          ...
                          <div className="mt-2.5 flex items-center justify-between gap-2">
                            ...
                            {hasDiscount && (
                              <span className="truncate text-[9px] text-white/20 line-through">
                                {formatPrice(
                                  product.compareAtPrice
                                )}
                              </span>
          ...
          <div className="px-5 pb-10">
            ...
            <div className="relative overflow-hidden rounded-[24px] border border-violet-400/10 bg-gradient-to-br from-violet-500/[0.10] via-white/[0.018] to-indigo-500/[0.06] px-5 py-6">

              <div className="pointer-events-none absolute -right-12 -top-12 h-32 w-32 rounded-full bg-violet-500/[0.12] blur-3xl" />

              <p className="relative text-[8px] font-bold uppercase tracking-[0.24em] text-violet-400">
                NEXORA
              </p>

              <h2 className="relative mt-2 text-xl font-semibold tracking-[-0.035em] text-white">
                Keep discovering.
              </h2>

              <p className="relative mt-2 text-[11px] leading-5 text-white/30">
                Explore the full collection and discover something worth bringing home.
              </p>

              <Link
                href="/products"
                className="relative mt-5 inline-flex rounded-xl bg-white px-4 py-3 text-[10px] font-semibold text-black"
              >
        ...
        {/* =========================================================
            DESKTOP EXPERIENCE
            DO NOT CHANGE — preserved separately.
        ========================================================= */}
          ...
          <section className="relative overflow-hidden border-b border-white/[0.06]">
            ...
            <div className="relative mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
              ...
              <div className="relative grid min-h-[245px] items-center gap-7 py-7 sm:min-h-[265px] sm:py-8 lg:grid-cols-[minmax(0,1fr)_270px] lg:gap-10 lg:py-9">
                ...
                {/* Desktop animated category showcase */}
                ...
                <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-2 max-w-xl text-sm leading-6 text-white/30">
                      Explore the full Nexora collection and discover something worth bringing home.
                    </p>
      ...
      {/* =========================================================
          ...
          Mobile only — existing approved component.
      ========================================================= */}
